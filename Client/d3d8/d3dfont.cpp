...
//
// File modified by Derek Abdine of the MultiTheftAuto team.
// File has been permitted for use in VC:MP by the MultiTheftAuto team.
//
//-----------------------------------------------------------------------------
#define STRICT
#include <stdio.h>
...
HRESULT CD3DFont::DrawText( FLOAT sx, FLOAT sy, DWORD dwColor,
                            const TCHAR* strText, DWORD dwFlags, BOOL bIgnoreCodes )
{
